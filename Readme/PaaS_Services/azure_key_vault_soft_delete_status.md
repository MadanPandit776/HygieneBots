# Azure Key Vault Soft Delete Status

## Overview
The Azure Key Vault Soft Delete Status Bot is a Python script designed to fetch the soft delete status of Key Vaults across All Azure subscriptions. It utilizes Azure services such as Azure SQL and Azure Identity for authentication and data storage.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_key_vault_soft_delete_status                      |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                |
| **Schedule run**     | Weekly                                                  |
...
- Fetches Azure Key Vault Soft Delete Status.
- Utilizes Azure SQL for storing Key Vault Soft Delete Status details.
...
## Setup
Follow these steps to set up the Azure Key Vault Soft Delete Status Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Key Vault Soft Delete Status Bot:
...
3. **Execution**:
   ...
   - Details on Key Vault Soft Delete Status are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Key Vault Soft Delete Status details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the Key Vault Soft Delete Status fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Key Vault Soft Delete Status, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/key-vault/general/soft-delete-overview).
