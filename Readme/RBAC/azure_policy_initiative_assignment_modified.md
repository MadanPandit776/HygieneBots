# Azure Policy Modifications Tracker Bot

## Overview
The Azure Policy Modifications Tracker Bot is a Python script designed to fetch policy changes from Azure Activity Logs. It tracks modifications such as creation, updates, and deletions of Azure Policy assignments over the past 7 days, across All Azure subscriptions. It utilizes Azure services such as Azure SQL and Azure Identity for authentication and data storage.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_policy_initiative_assignment_modified             |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                        |
| **Schedule run**     | Daily                                                        |
...
- Fetches Policy changes from Azure Activity Logs, including policy creation, updates, and deletions.
- Utilizes Azure SQL for storing Policy changes details.
...
## Setup
Follow these steps to set up the Azure Policy Modifications Tracker Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Policy Modifications Tracker Bot:
...
3. **Execution**:
   ...
   - Details on Policy changes are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Policy changes details.

   ## Email Notification (Regular/Failure)
The Azure Policy Modifications Tracker Bot includes email notification functionality to keep stakeholders informed about the execution status and any potential issues. Here's how it works:
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the Policy changes fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Policy changes, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/governance/policy/how-to/get-compliance-data).
