# Azure Route Table Seven Days modification Track Changes Bot

## Overview
The Python script designed to monitor and track modifications made to route tables across All Azure subscriptions. It retrieves activity logs for Route Table related operations within a specified timeframe.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_route_table_seven_days_modification_track_changes |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                |
| **Schedule run**     | Weekly                                                  |
...
- Fetches Azure Route Table Seven Days modification Track Changes.
- Utilizes Azure SQL for storing Azure Route Table Seven Days modification Track Changes details.
...
## Setup
Follow these steps to set up the Azure Route Table Seven Days modification Track Changes Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Route Table Seven Days modification Track Changes Bot:
...
3. **Execution**:
   ...
   - Details on Route Table Seven Days modification Track Changes are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Route Table Seven Days modification Track Changes details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the Route table modifications fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Route Table Seven Days modification Track Changes, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/virtual-network/manage-route-table).
