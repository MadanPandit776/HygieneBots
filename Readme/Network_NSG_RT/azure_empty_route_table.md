# Azure Empty Route Table Bot

## Overview
The Azure Empty Route Table Bot is a Python script designed to fetch route tables that are not associated with any subnets across all Azure subscriptions. It utilizes Azure services such as Azure SQL and Azure Identity for authentication and data storage.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_empty_route_table                                 |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                        |
| **Schedule run**     | Weekly                                                        |
...
- Fetches route tables not associated with any subnets.
- Utilizes Azure SQL for storing details of route tables without subnet details.
...
## Setup
Follow these steps to set up the Azure Empty Route Table Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Empty Route Table Bot:
...
3. **Execution**:
   ...
   - Empty Route Table details are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Empty Route Table details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the Empty Route Table fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Empty Route Table, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/virtual-network/manage-route-table).
