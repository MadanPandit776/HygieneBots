# Azure Nsg Seven Days Modification Track Changes Bot

## Overview
The Python script designed to fetch changes made to Network Security Groups (NSGs) across All Azure subscriptions. It retrieves activity logs for NSG-related operations within a specified timeframe.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_nsg_seven_days_modification_track_changes         |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                |
| **Schedule run**     | Weekly                                                  |
...
- Fetches Nsg Seven Days Modification Track Changes.
- Utilizes Azure SQL for storing Nsg Seven Days Modification Track Changes details.
...
## Setup
Follow these steps to set up the Azure Nsg Seven Days Modification Track Changes Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Nsg Seven Days Modification Track Changes Bot:
...
3. **Execution**:
   ...
   - Details on Nsg Seven Days Modification Track Changes are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Nsg Seven Days Modification Track Changes details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the NSG  Modifications fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Nsg Seven Days Modification Track Changes, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/virtual-network/manage-network-security-group).
