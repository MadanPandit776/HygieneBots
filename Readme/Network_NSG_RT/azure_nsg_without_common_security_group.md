# Azure NSG Common Rules Validation Bot

## Overview
The Azure NSG Common Rules Validation Bot is a Python script designed to check Network Security Groups (NSGs) across all Azure subscriptions for missing common security rules. It utilizes Azure services such as Azure SQL and Azure Identity for authentication and data storage.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_nsg_without_common_security_group                 |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                        |
| **Schedule run**     | Daily                                                        |
...
- Fetches and validates NSGs across all Azure subscriptions to ensure the presence of common security rules.
- Utilizes Azure SQL for storing the details of NSGs missing common rules.
...
## Setup
Follow these steps to set up the Azure NSG Common Rules Validation Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure NSG Common Rules Validation Bot:
...
3. **Execution**:
   ...
   - Details on NSGs missing common rules are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for NSGs missing common rules details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the NSG Common Rules Validation fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring NSG Common Rules Validation, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/virtual-network/network-security-groups-overview).
