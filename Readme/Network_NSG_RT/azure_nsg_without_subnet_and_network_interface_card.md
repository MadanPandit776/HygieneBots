# Azure NSG Without Subnets and NICs Bot

## Overview
The Azure NSG Without Subnets and NICs Bot is a Python script designed to fetch Network Security Groups (NSGs) that are not associated with any subnets or network interfaces across all Azure subscriptions. It utilizes Azure services such as Azure SQL and Azure Identity for authentication and data storage.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_nsg_without_subnet_and_network_interface_card     |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                        |
| **Schedule run**     | Daily                                                        |
...
- Fetches NSGs without associated subnets or network interfaces.
- Utilizes Azure SQL for storing NSGs details.
...
## Setup
Follow these steps to set up the Azure NSG Without Subnets and NICs Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure NSG Without Subnets and NICs Bot:
...
3. **Execution**:
   ...
   - Details on NSGs without subnets and NICs are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for NSGs without subnets and NICs details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the NSGs without subnets and NICs fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring NSGs without subnets and NICs, refer to the [Microsoft Azure documentation](https://techcommunity.microsoft.com/t5/azure-architecture/ms-guidance-on-nsgs-on-nics-vs-on-subnets/m-p/1501368).
