# Azure Empty Load Balancer and Application Gateway Bot

## Overview
The Azure Empty Load Balancer and Application Gateway Bot is a Python script designed to identify and report on Azure Load Balancers and Application Gateways that have no associated backend resources. It ensures proactive monitoring and notification of empty load balancer instances, facilitating efficient resource management and optimization across Azure services.

## Features

| Feature              | Details                                                 |
|----------------------|---------------------------------------------------------|
| **Naming convention**| azure_empty_load_balancer_&_application_gateway         |
| **Type**             | Scan-Report                                             |
| **Services**         | Security                                                |
| **Schedule run**     | Weekly                                                  |
...
- Fetches Azure Empty Load Balancer and Application Gateway.
- Utilizes Azure SQL for storing Azure Empty Load Balancer and Application Gateway details.
...
## Setup
Follow these steps to set up the Azure Empty Load Balancer and Application Gateway Bot:
...
## Bot Execution Steps
Follow these guidelines for using the Azure Empty Load Balancer and Application Gateway Bot:
...
3. **Execution**:
   ...
   - Empty Load Balancer and Application Gateway details are stored in Azure SQL Database.
...
4. **Monitoring**:
   ...
   - Review Azure SQL Database for Empty Load Balancer and Application Gateway details.
...
- **Report Email Notifications**: 
  - Additionally, the bot sends a detailed report via email after each execution, summarizing the Empty Load Balancer and Application Gateway fetched, any exceptions encountered, and the overall execution status. This report provides stakeholders with comprehensive insights into the bot's performance and any potential issues that need attention.

## Additional Documentation
For detailed instructions on configuring Empty Load Balancer and Application Gateway, refer to the [Microsoft Azure documentation](https://learn.microsoft.com/en-us/azure/load-balancer/manage-rules-how-to)(https://learn.microsoft.com/en-us/azure/application-gateway/create-url-route-portal).
